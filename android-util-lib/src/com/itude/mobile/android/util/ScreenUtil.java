...
public class ScreenUtil
{
  ...
  {
    final float height = _context.getResources().getDisplayMetrics().heightPixels;
    return (int) ((height / 100) * percentage);
  }

  public final static int getWidthPixelsForPercentage(float percentage)
  {
    final float width = _context.getResources().getDisplayMetrics().widthPixels;

    return (int) ((width / 100) * percentage);
  }

  public final static void setContext(Context _context)
  {
    ScreenUtil._context = _context;
  }
