package com.itude.mobile.android.util.cache;
...
{
  private static final String       TAG = "MBCacheWriter";
  ...
  public void run()
  {
    try
    {
      ...
      if (success && getData() != null)
      {
        ...
        if (!success) Log.e(TAG, "Error caching data in " + getFileName());
      }
      else if (!success) Log.w(TAG, "Could not store the cache registry info in " + getRegistryFileName() + " and/or " + getTtlsFileName()
